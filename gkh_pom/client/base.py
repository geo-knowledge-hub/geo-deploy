...
client/base.py
==============
BaseClient — shared HTTP session and helper methods.
All other client classes inherit from this.

If the base URL or auth mechanism ever changes, update only this file.
"""
